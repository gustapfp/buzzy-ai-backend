...
* `sem_estado` — Ambíguo/indecidível/sem estado anterior
...
Resposta esperada: Cliente esta intagindo com uma saudação, logo o estado que essa mensagem pertence é o de saudacao.

Mensagens recebida: Sim
